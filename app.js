    ...
    return {
        populateItemList: function (items) {
            ...
            items.forEach(function (item) {
                liItems += `<li id="item-${item.id}" class="collection-item">
                <strong> ${item.name} </strong> <em>${item.calories} Calories</em>
                <a href="#" class="secondary-content"><i class=" edit-item fa fa-pencil"></i></a>`;
            });

            document.querySelector(UISelectors.itemList).innerHTML = liItems;
        },
        ...
        addListItem: function (newItem) {
            ...
            liItem.id = `item-${newItem.id}`;
            liItem.innerHTML = `<strong> ${newItem.name} </strong> <em>${newItem.calories} Calories</em>
            <a href="#" class="secondary-content"><i class=" edit-item fa fa-pencil"></i></a>`;
            document.querySelector(UISelectors.itemList).insertAdjacentElement('beforeend', liItem);
        ...
        addItemToForm: function () {
            const itemToEdit = ItemCtrl.getCurrentItem();
